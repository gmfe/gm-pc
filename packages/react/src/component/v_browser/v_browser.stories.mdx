...
import { Vbrowser } from './v_browser.tsx'

<Meta title="窗口/页签" component={Vbrowser} />
...
基本大多数情况下可以继续使用 `useEffect`，某些场景下则需要改用 `useWindowEffect`，比如希望窗口激活后刷新数据。
