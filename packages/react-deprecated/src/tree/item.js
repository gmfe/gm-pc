...
const LeafItem = (props) => {
  ...
  return (
    <Flex
      className={classNames('gm-hover-bg gm-tree-list-item gm-cursor ', `gm-level-${_level}`, {
        disabled,
      })}
      data-level={_level}
    >
...
const GroupItem = (props) => {
  ...
  return (
    <>
      <Flex
        className={classNames('gm-tree-group-item gm-cursor gm-hover-bg', `gm-level-${_level}`, {
          disabled,
        })}
        data-level={_level}
      >
