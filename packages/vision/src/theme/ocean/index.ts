import { StyleSheetCfg, StyleSheet } from '../../types/theme'
import { chartStyleSheet } from './chart'

type chartStyle = ReturnType<typeof chartStyleSheet>

export const PRIMARY_COLORS = {
  45: 'rgba(68,200,229,0.5)', // 浅青
  25: '#1f48c6', // 深蓝色
  15: '#4de4fd', // 青色
  6: 'transparent', // 背景色  #060847
}
...
export const createOceanStyleSheet = (
  cfg: StyleSheetCfg<chartStyle> = {}
): StyleSheet<chartStyle> => {
  const {
    backgroundColor = PRIMARY_COLORS[6],
  ...
  return {
    ...
    sliderRailBorder: 0,
    /** 连续图例滑块边框颜色 */
    sliderRailBorderColor: undefined,
    /** 连续图例滑块宽度 */
    sliderRailWidth: 100,
    /** 连续图例滑块高度 */
    sliderRailHeight: 12,
    ...
    /** text 图形标注文本边框颜色 */
    annotationTextBorderColor: undefined,
    /** text 图形标注文本边框粗细 */
    ...
    /** region 图形标注描边颜色 */
    annotationRegionBorderColor: undefined,
    ...
    tooltipCrosshairsBorderColor: PRIMARY_COLORS[15],
    /** tooltip crosshairs 辅助线粗细 */
    tooltipCrosshairsBorder: 1,
    /** tooltip crosshairs 辅助线虚线间隔 */
    tooltipCrosshairsLineDash: undefined,

    /** tooltip 内容框背景色 */
    tooltipContainerFillColor: `linear-gradient(${PRIMARY_COLORS[15]} -95%, ${PRIMARY_COLORS[25]} 80%)`,
    ...
    tooltipMarkerStroke: PRIMARY_COLORS[15],
    tooltipMarkerFill: PRIMARY_COLORS[15],
    ...
    innerLabelBorderColor: undefined,
    ...
    intervalActiveBorderColor: BLACK_COLORS[85],
...
const ocean = createOceanStyleSheet()
ocean.chart = chartStyleSheet(PRIMARY_COLORS)
